...
window.addEventListener("load",function() {
    ...
    var renderer, scene, camera, geometry, material, mesh, light;

    // 描画領域をHTMLに確保するためのコンテナ用変数
    var container = document.getElementById('num3');
    ...
    geometry = new THREE.SphereGeometry( 150, 6, 6 );
    ...
    material = new THREE.MeshLambertMaterial( { color: 0x333333, wireframe: false } );
